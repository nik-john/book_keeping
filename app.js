...
function parseData(data) {
    post(`https://bokiotestbankapi.azurewebsites.net/api/${KEY}/Transactions/Parse`, data).then(handleParsedData, error);
}
...
async function deDupe() {
    ...
    return post(`https://bokiotestbankapi.azurewebsites.net/api/${KEY}/Transactions/Preview`, preppedData).then(handlePreview, error);
}
function handlePreview(data) {
    document.getElementById('parsed-data').value = JSON.stringify(data);
    data.filter(row => row.ignore).map(row => {
...
console.log(`/*  Features, Bugs and TODOs Etc. */
    Features:
